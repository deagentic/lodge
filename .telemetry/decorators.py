    ...
    def decorator(func: F) -> F:
        ...
        def wrapper(*args: Any, **kwargs: Any) -> Any:
            ...
            try:
                ...
                send_event(
                    make_event(
                        "skill.invoked", _PROJECT_SLUG, _GITHUB_USERNAME, payload
                    )
                )
    ...
    def decorator(func: F) -> F:
        ...
        def wrapper(*args: Any, **kwargs: Any) -> Any:
            ...
            try:
                ...
                send_event(
                    make_event(
                        "tool.executed", _PROJECT_SLUG, _GITHUB_USERNAME, payload
                    )
                )
...
def track_knowledge_created(
    kind: str, path: str, commit_sha: str | None = None
) -> None:
    """
    ...
    send_event(
        make_event("knowledge.created", _PROJECT_SLUG, _GITHUB_USERNAME, payload)
    )
