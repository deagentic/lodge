...
def build_call_tree(path: Path, tech_stack: dict, structure: dict) -> dict:
    ...
    entry_flows = _trace_entry_flows(structure.get('entry_points', []), structure, graph)
...
def _process_c_function(source: str, rel: str, fname: str, start: int, end: int, edges: list) -> None:
...
def _process_js_line(line: str, i: int, rel: str, current_func: str, edges: list) -> None:
    if current_func:
...
def _process_cs_line(line: str, i: int, rel: str, current_method: str, edges: list) -> None:
    if current_method:
...
def _process_generic_line(line: str, i: int, rel: str, current: str, edges: list) -> None:
    if current:
...
def _add_dot_edges(caller: str, callees: list, highlight: set, seen_nodes: set, lines: list):
