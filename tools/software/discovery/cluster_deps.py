...
def _process_dir_files(root: str, files: list[str], clusters: dict):
    if 'package.json' in files:
        _process_deps_file(root, 'package.json', extract_deps_package_json, 'npm', clusters)

    if 'requirements.txt' in files:
        _process_deps_file(root, 'requirements.txt', extract_deps_requirements, 'pip', clusters)
